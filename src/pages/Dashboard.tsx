...
import { LogOut, User, MessageSquare, FileText, Settings, CheckCircle, Circle } from 'lucide-react';
        ...
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex items-center gap-2">
                {profile?.profile_completed ? (
                  ...
                  <>
                    <Circle className="text-[#FDC787]" size={20} />
                    <span className="text-[#FDC787] font-medium">Incomplete</span>
                  </>
                )}
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <button
              ...
              className="bg-[#012A61] bg-opacity-50 backdrop-blur-lg border border-[#A5CCCC] border-opacity-20 rounded-2xl p-8 hover:bg-opacity-70 transition-all duration-300 text-left group"
            >
              <div className="bg-[#275A91] w-14 h-14 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                <User className="text-[#FDC787]" size={28} />
              </div>
            ...
            >
              <div className="bg-[#275A91] w-14 h-14 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                <MessageSquare className="text-[#FDC787]" size={28} />
              </div>
            ...
            >
              <div className="bg-[#275A91] w-14 h-14 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                <FileText className="text-[#FDC787]" size={28} />
              </div>
